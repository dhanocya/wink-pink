            ...
            <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-6xl mx-auto px-4">
                    ...
                    <div className="flex shadow-lg rounded-r-md overflow-hidden bg-white min-h-[140px]">
                        <div className="bg-[#eef430] w-[20px] flex-shrink-0"></div>
                        <div className="flex flex-col justify-center p-6 w-full">
                            <p className="text-xl font-bold text-[#034a27] mb-2">We Learn From Real Usage</p>
                            <p className="text-gray-600 text-sm leading-relaxed">We track how people actually interact with your store—and refine what isn’t working.</p>
                        </div>
                    </div>
